...
public class ViewRequestStatus extends AppCompatActivity {
    ...
    ListView list;
    String[] date,time, officer, status, reqid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    officer[i]=u.getString("officer");
                                    reqid[i]=u.getString("reqid");
                                }

                                // ArrayAdapter<String> adpt=new ArrayAdapter<String>(getApplicationContext(),android.R.layout.simple_list_item_1,name);
                                list.setAdapter(new CustomViewRequestStatus(getApplicationContext(), date, time, status, officer));
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(getApplicationContext(), ViewItemsActivity.class).putExtra("reqid", reqid[position]));
            }
        });
