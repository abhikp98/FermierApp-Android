...
public class ViewComplaints extends AppCompatActivity {
    ...
    String[] complaint, cdate, reply, replydate;
    ListView li;
...
//                                }
                                ...
                                li.setAdapter(new CustomViewComplaints(getApplicationContext(),complaint,cdate, reply, replydate));
