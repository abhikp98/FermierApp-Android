...
//                                            startActivity( new Intent( getApplicationContext(), Usersuggestion.class ) );
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            params.put( "toid", getIntent().getStringExtra("offid") );
